  ...
  return (
    <>
      <section className="bg-[#E4E4E4] py-12  overflow-hidden">
        <h2 className="font-bold text-center text-3xl sm:text-6xl">
          Our Clientele
        </h2>

        <div
          className="border-t-4 border-black w-24 mx-auto mt-4 mb-10"
          ...
          <div className="flex animate-marquee gap-6">
            {[...logos, ...logos].map((logo, i) => (
              <Image
                ...
                width={120}
                height={80}
                className="bg-white p-3 border rounded shadow-md"
              />
            ))}
          </div>
        </div>
